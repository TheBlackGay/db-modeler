...
import type { EolinkerApi, EolinkerApiGroup, HttpMethod, ApiStatus } from '../../../types/models';

interface ApiFormProps {
  visible: boolean;
  onCancel: () => void;
  onSubmit: (values: Omit<EolinkerApi, 'id' | 'created_at' | 'updated_at'>) => void;
  groups: EolinkerApiGroup[];
  initialValues?: Partial<EolinkerApi>;
}
